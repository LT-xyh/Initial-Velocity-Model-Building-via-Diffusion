...
def test_velocity_gan(dataset_name,):
    ...
    conf.testing.ckpt_path = 'logs/baselines/velocity_gan/tensorboard/260122-15_All_data_-VelocityGAN_rms_smooth/checkpoints/epoch_92-ssim_0.596.ckpt'
...
if __name__ == '__main__':
    for dataset_name in ['CurveVelA', 'FlatVelA', 'FlatVelB', 'CurveVelB']:
        ...
        test_velocity_gan(dataset_name)
